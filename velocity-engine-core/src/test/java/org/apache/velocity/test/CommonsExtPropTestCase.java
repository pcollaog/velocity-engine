    ...
    extends AbstractBaseTest
{
     ...
     */
    private static final String COMPARE_DIR = TEST_COMPARE_DIR + "/configuration/compare";
     ...
     * Test configuration
     */
    private static final String TEST_CONFIG = TEST_COMPARE_DIR + "/configuration/test-config.properties";
