    ...
    extends AbstractBaseTest
{
    ...
    public void testIt()
    {
        String template = "#set( $foo = 'old' )" + "#macro( test $foo )" + "#set( $foo = \"new $foo \" )" + "$foo"
            + "#end" + "#test( 'foo' )" + "$foo";
    ...
    public void testForIrrationallyFearedRelatedPossibleProblem()
    {
        ...
        String template = "#macro( test $a )" + "$a" + "$a" + "#end" + "#test( \"$i\" )$i";
    ...
    {
        context.put( "i", new Inc() );
        String template = "#macro( test $a )" + "#set( $a = 'a' )" + "$a" + "$a" + "#end" + "#test( \"$i\" )$i";
    ...
    {
        context.put( "i", new Inc() );
        String template = "#macro( test $a )" + "$a" + "$a" + "#end" + "#test( $i.plus() )$i";
        assertEvalEquals( "001", template );
    }
    ...
    {
        context.put( "i", new Inc() );
        String template = "#macro( test $a )" + "#set( $a = $i )" + "$a" + "$a" + "#end" + "#test( 'a' )$i";
        assertEvalEquals( "012", template );
    }
    ...
    {
        String template = "#macro(myMacro $result)" + "  #set($result = 'some value')" + "#end" + "#myMacro($x)" + "$x";
