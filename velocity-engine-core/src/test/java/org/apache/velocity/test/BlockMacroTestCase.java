    ...
    extends AbstractBaseTest
{
    ...
    public void testVelocity686()
        throws Exception
    {
        String template = "#macro(foo)#set( $x = $bodyContent )#end" + "#@foo()b#end a $x ";
    ...
    {
        String template = "#macro(foo)foo:$bodyContent#end" + "#macro(bar)bar:$bodyContent#end"
    ...
    public void testRecursiveBlockMacro()
    {
        ...
        String template = "#macro(foo)start:$bodyContent#end" + "#@foo()call:$bodyContent#end";
