 ...
 */
public class ArrayMethodsTestCase
    extends BaseTestCase
{
    ...
    private void checkResults( Object array, Object setme, boolean compareToList )
        throws Exception
    {
        ...
        if ( compareToList )
        {
            ...
            context.put( "list", new ArrayList<Object>( Arrays.asList( (Object[]) array ) ) );
        }
    ...
    private void checkResult( String method, String expected, boolean compareToList )
        throws Exception
    {
