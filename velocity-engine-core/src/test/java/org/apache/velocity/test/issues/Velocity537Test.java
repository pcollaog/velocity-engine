    ...
    extends AbstractBaseTest
{
    ...
    @Test
    public void testVelocity537Again()
        throws Exception
    {
        ...
        throws Exception
    {
        ...
        if ( !isMatch( RESULTS_DIR, COMPARE_DIR, templateName, RESULT_FILE_EXT, CMP_FILE_EXT ) )
        {
            ...
            fail( "Output incorrect for Template: " + templateName + ": \"" + out + "\"" + "; it did not match: \""
                + compare + "\"" );
        }
