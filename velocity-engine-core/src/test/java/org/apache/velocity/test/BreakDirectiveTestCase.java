 ...
 */
public class BreakDirectiveTestCase
    extends AbstractBaseTest
{
    ...
    public void testStopMacro()
    {
        ...
        assertEvalEquals( "b c ", "#macro(c)c #break($macro.parent) d#end" + "#macro(b)b #c c#end" + "#b" );
    ...
    {
        assertEvalEquals( " a ", "#macro(a) $bodyContent #end" + "#@a()a#break($a)b#end" );
        assertEvalEquals( " b ", "#macro(b) $bodyContent #end" + "#@b()b#{break}c#end" );
    }
}
