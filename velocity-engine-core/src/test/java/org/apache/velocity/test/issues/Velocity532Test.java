    ...
    extends AbstractBaseTest
{
    ...
    public void test532()
    {
        String template = "#macro( test )$foreach.count#end" + "#foreach( $i in [1..5] )#test()#end";
    ...
    public void test532b()
    {
        ...
        String template = "#macro( test $baz )" + "#if( $foo == $null )" + "#if( $foreach.count == 3 )bar#end"
            + "#end#end" + "#foreach( $i in [1..5] )#test($i)#end";
